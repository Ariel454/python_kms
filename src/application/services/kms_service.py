from src.application.features.key_storage.use_cases.decrypt_data import DecryptDataUseCase
from src.application.features.key_storage.use_cases.encrypt_data import EncryptDataUseCase
from src.application.features.key_storage.use_cases.generate_key import GenerateKeyUseCase


class KMSService:
    def __init__(self, generate_key_use_case: GenerateKeyUseCase, encrypt_data_use_case: EncryptDataUseCase, decrypt_data_use_case: DecryptDataUseCase):
